(function() {
  ...
  callWithJQuery(function($) {
    ...
    Utilities
     */
    var PivotData, addSeparators, aggregatorTemplates, aggregators, dayNamesEn, derivers, getSort, locales, mthNamesEn, naturalSort, naturalSort2,  numberFormat, pivotTableRenderer, renderers, sortAs, usFmt, usFmtInt, usFmtPct, zeroPad;
...
naturalSort2 = function() {

      return function(bs, as) {
        var a, a1, b, b1, rd, rx, rz;
        rx = /(\d+)|(\D+)/g;
        rd = /\d/;
        rz = /^0/;
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        fn = function(c) {
          ...
          rotatesel = opts.rotate.find(function (e) { return e == c; })!=null;
          if (keys.length > opts.menuLimit) {
            valueList.append($("<p>").html(opts.localeStrings.tooMany));
            btns = $("<p>").appendTo(valueList);
$("<input>").attr("type", "checkbox").addClass('pvtrotate').attr("checked", rotatesel).data("rotate", [c]).appendTo(btns);
btns.append(opts.localeStrings.rotate);
 ...
 $("<input>").attr("type", "checkbox").addClass('pvtrotate').attr("checked", rotatesel).data("rotate", [c]).appendTo(btns);
        ...
        refreshDelayed = (function(_this) {
          return function() {
            ...
            rotate = [];
            _this.find('input.pvtrotate:checked').each(function() { rotate.push($(this).data("rotate")); });
